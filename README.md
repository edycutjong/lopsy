<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Lopsy Hero" width="100%">
  
  <p><em>LP forensics with emergency Zap-Out via LPAgent. Save your bleeding positions.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://lpagent.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-lpagent)
</div>
...
LP forensics with emergency Zap-Out via LPAgent. Save your bleeding positions.
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-lpagent.git
   cd frontier-lpagent
   ```
